...
## ----------------------------------------------------------------------------------------------------------------
Math_Oly_data %>% filter(year == 2019) %>% filter(!is.na(Average_yearly_temperature)) %>% ggplot(., aes(x = Average_yearly_temperature, y = rank)) + geom_point() + geom_smooth(method = "glm")
...
## ----------------------------------------------------------------------------------------------------------------
Math_Oly_data %>% filter(year == 2019) %>% filter(!is.na(Average_yearly_temperature)) %>% filter(!is.na(`2019`)) %>% ggplot(., aes(x = `2019`, y = rank)) + geom_point() + geom_smooth(method = "glm")
...
## ----------------------------------------------------------------------------------------------------------------
Math_Oly_data2 %>% filter(year == 2019) %>% filter(!is.na(GDP_per_capita)) %>% filter(!is.na(Average_yearly_temperature)) %>% ggplot(., aes(x = GDP_per_capita, y = rank)) + geom_point() + geom_smooth(method = "glm")
...
## ----------------------------------------------------------------------------------------------------------------
Math_Oly_data2 %>% filter(year == 2019) %>% filter(!is.na(GDP_per_capita)) %>% filter(!is.na(Average_yearly_temperature)) %>% filter(!is.na(Gov_expenditure_on_educa)) %>% ggplot(., aes(x = Gov_expenditure_on_educa, y = rank)) + geom_point() + geom_smooth(method = "glm")
...
## ----------------------------------------------------------------------------------------------------------------
Math_Oly_data2 %>% count(.)
Math_Oly_data2 %>% filter(year == 2019) %>% count(is.na(Average_yearly_temperature) | is.na(GDP_per_capita) | is.na(Gov_expenditure_on_educa))
